...
if type -q kubectl
  ...
  abbr -a -g kldsf "kubectl get daemonsets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl logs daemonset/{}"
  abbr -a -g klssf "kubectl get statefulsets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl logs statefulset/{}"
  ...
  # k edit ...
  abbr -a -g kepo "kubectl edit pod"
  abbr -a -g keing "kubectl edit ingress"
  abbr -a -g kesvc "kubectl edit service"
  abbr -a -g kecm "kubectl edit configmap"
  abbr -a -g kes "kubectl edit secret"
  abbr -a -g keds "kubectl edit daemonset"
  abbr -a -g ked "kubectl edit deployment"
  abbr -a -g kepv "kubectl edit persistentvolume"
  abbr -a -g kepvc "kubectl edit persistentvolumeclaim"
  abbr -a -g kesa "kubectl edit serviceaccount"
  abbr -a -g kens "kubectl edit namespace"
  abbr -a -g keno "kubectl edit node"
  abbr -a -g kecrd "kubectl edit customresourcedefinition"
  abbr -a -g kests "kubectl edit statefulset"
  abbr -a -g kehpa "kubectl edit horizontalpodautoscaler"
  abbr -a -g kecj "kubectl edit cronjob"
  abbr -a -g kej "kubectl edit job"
  abbr -a -g kenetpol "kubectl edit networkpolicy"
  abbr -a -g ker "kubectl edit role"
  abbr -a -g kerb "kubectl edit rolebinding"
  abbr -a -g kecr "kubectl edit clusterrole"
  abbr -a -g kecrb "kubectl edit clusterrolebinding"
  abbr -a -g kesc "kubectl edit storageclass"
  abbr -a -g kers "kubectl edit replicaset"
  # k edit ... (fuzzy)
  abbr -a -g kepof "kubectl get pods | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit pod {}"
  abbr -a -g keingf "kubectl get ingress | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit ingress {}"
  abbr -a -g kesvcf "kubectl get services | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit service {}"
  abbr -a -g kecmf "kubectl get configmaps | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit configmap {}"
  abbr -a -g kesf "kubectl get secrets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit secret {}"
  abbr -a -g kedsf "kubectl get daemonsets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit daemonset {}"
  abbr -a -g kedf "kubectl get deployments | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit deployment {}"
  abbr -a -g kepvf "kubectl get persistentvolumes | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit persistentvolume {}"
  abbr -a -g kepvcf "kubectl get persistentvolumeclaims | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit persistentvolumeclaim {}"
  abbr -a -g kesaf "kubectl get serviceaccounts | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit serviceaccount {}"
  abbr -a -g kensf "kubectl get namespaces | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit namespace {}"
  abbr -a -g kenof "kubectl get nodes | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit node {}"
  abbr -a -g kecrdf "kubectl get customresourcedefinitions | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit customresourcedefinition {}"
  abbr -a -g kestsf "kubectl get statefulsets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit statefulset {}"
  abbr -a -g kehpaf "kubectl get horizontalpodautoscalers | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit horizontalpodautoscaler {}"
  abbr -a -g kecjf "kubectl get cronjobs | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit cronjob {}"
  abbr -a -g kejf "kubectl get jobs | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit job {}"
  abbr -a -g kenetpolf "kubectl get networkpolicies | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit networkpolicy {}"
  abbr -a -g kerf "kubectl get roles | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit role {}"
  abbr -a -g kerbf "kubectl get rolebindings | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit rolebinding {}"
  abbr -a -g kecrf "kubectl get clusterroles | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit clusterrole {}"
  abbr -a -g kecrbf "kubectl get clusterrolebindings | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit clusterrolebinding {}"
  abbr -a -g kescf "kubectl get storageclasses | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit storageclass {}"
  abbr -a -g kersf "kubectl get replicasets | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit replicaset {}"
  abbr -a -g keendf "kubectl get endpoints | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl edit endpoint {}"
  ...
  abbr -a -g kgend "kubectl get endpoints"
  # k get ... (yaml)
  ...
  abbr -a -g kgendy "kubectl get endpoints -o yaml"
  ...
  abbr -a -g kgendf "kubectl get endpoints | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl neat endpoints {} -o yaml"
  ...
  abbr -a -g kdend "kubectl describe endpoints"
  # k describe ... (fuzzy)
  ...
  abbr -a -g kdendf "kubectl get endpoints | fzf --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl describe endpoint {}"
  # k delete ... (fuzzy)
  abbr -a -g kdelpof "kubectl get pods | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete pod {} --wait=false --now=true"
  abbr -a -g kdelingf "kubectl get ingress | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete ingress {} --wait=false --now=true"
  abbr -a -g kdelsvcf "kubectl get services | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete service {} --wait=false --now=true"
  abbr -a -g kdelcmf "kubectl get configmaps | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete configmap {} --wait=false --now=true"
  abbr -a -g kdelsf "kubectl get secrets | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete secret {} --wait=false --now=true"
  abbr -a -g kdeldsf "kubectl get daemonsets | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete daemonset {} --wait=false --now=true"
  abbr -a -g kdeldf "kubectl get deployments | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete deployment {} --wait=false --now=true"
  abbr -a -g kdelpvf "kubectl get persistentvolumes | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete persistentvolume {} --wait=false --now=true"
  abbr -a -g kdelpvcf "kubectl get persistentvolumeclaims | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete persistentvolumeclaim {} --wait=false --now=true"
  abbr -a -g kdelsaf "kubectl get serviceaccounts | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete serviceaccount {} --wait=false --now=true"
  ...
  abbr -a -g kdelnof "kubectl get nodes | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete node {} --wait=false --now=true"
  abbr -a -g kdelcrdf "kubectl get customresourcedefinitions | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete customresourcedefinition {} --wait=false --now=true"
  abbr -a -g kdelstsf "kubectl get statefulsets | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete statefulset {} --wait=false --now=true"
  abbr -a -g kdelhpaf "kubectl get horizontalpodautoscalers | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete horizontalpodautoscaler {} --wait=false --now=true"
  abbr -a -g kdelcjf "kubectl get cronjobs | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete cronjob {} --wait=false --now=true"
  abbr -a -g kdeljf "kubectl get jobs | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete job {} --wait=false --now=true"
  abbr -a -g kdelnetpolf "kubectl get networkpolicies | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete networkpolicy {} --wait=false --now=true"
  abbr -a -g kdelrf "kubectl get roles | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete role {} --wait=false --now=true"
  abbr -a -g kdelrbf "kubectl get rolebindings | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete rolebinding {} --wait=false --now=true"
  abbr -a -g kdelcrf "kubectl get clusterroles | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete clusterrole {} --wait=false --now=true"
  abbr -a -g kdelcrbf "kubectl get clusterrolebindings | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete clusterrolebinding {} --wait=false --now=true"
  abbr -a -g kdelscf "kubectl get storageclasses | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete storageclass {} --wait=false --now=true"
  abbr -a -g kdelendf "kubectl get replicasets | fzf -m --ansi --header-lines=1 | awk '{print \$1}' | xargs -I{} kubectl delete replicaset {} --wait=false --now=true"
