  ...
  options = with types; {
    name = mkOption {
      ...
      defaultText = lib.literalMD ''
        Lima built-in default: same as the host username, if it is a valid Linux
        username, otherwise "lima".
      '';
      description = ''
    ...
    uid = mkOption {
      ...
      default = null;
      defaultText = lib.literalMD ''
        Lima built-in default: same as the host user id of the current user (NOT a
        lookup of the specified "username").
      '';
      description = ''
