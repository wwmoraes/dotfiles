...
if [ "${DEFAULTS:-0}" = "1" ]; then
  ...
  echo "setting: only show scrollbars when scrolling"
  ...
  echo "setting: Enable lid wakeup"
  ...
  echo "setting: Disable the all too sensitive backswipe on trackpads"
  defaults write com.google.Chrome AppleEnableSwipeNavigateWithScrolls -bool false
  defaults write com.google.Chrome.canary AppleEnableSwipeNavigateWithScrolls -bool false

  echo "setting: Disable the all too sensitive backswipe on Magic Mouse"
